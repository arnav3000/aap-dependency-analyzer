...
from aap_migration_planner.client.base_client import BaseAPIClient
from aap_migration_planner.config import AAPInstanceConfig
from aap_migration_planner.utils.logging import get_logger
from aap_migration_planner.utils.retry import retry_api_call

logger = get_logger(__name__)


class AAPClient(BaseAPIClient):
    ...
    def __init__(
        ...
        logger.info("aap_client_initialized", url=config.url)
